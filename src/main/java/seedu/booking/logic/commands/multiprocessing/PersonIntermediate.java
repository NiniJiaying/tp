...
public class PersonIntermediate implements Intermediate<AddPersonCommand> {
    ...
    /**
     * Initialised a Person Intermediate to store tempoary user input
     */
    public PersonIntermediate() {
        this.name = null;
        this.phone = null;
        this.email = null;
        this.tags = null;
